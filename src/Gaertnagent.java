...
public class Gaertnagent implements IAgent {
    ...
    public Direction getAction(Senses senses) {
        ...
        if ((senses.isMine(Direction.EAST) || senses.isMine(Direction.NORTHEAST))
                && !senses.isMine(Direction.NORTH))
            return Direction.NORTH;
        else if ((senses.isMine(Direction.SOUTHEAST)
                || senses.isMine(Direction.SOUTH))
                && !senses.isMine(Direction.EAST))
            return Direction.EAST;
        else if ((senses.isMine(Direction.SOUTHWEST)
                || senses.isMine(Direction.WEST))
                && !senses.isMine(Direction.SOUTH))
